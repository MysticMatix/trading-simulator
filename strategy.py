...
class TradingStrategy(ABC):
    ...
    def should_buy(self, data_point: dict) -> bool:
        """Abstract method, returns True if the strategy suggests a buy for the current data point, otherwise False."""
        pass

    @abstractmethod
    def should_sell(self, data_point: dict) -> bool:
        """Abstract method, returns True if the strategy suggests a sell for the current data point, otherwise False."""
        pass
